...
function checkout() {
    ...
    const createCheckoutSesion= async ()=>{
         ...
         const checkoutSession = await fetch('/api/create-checkout-session',{ method: 'post'});

         const sessionn = await checkoutSession.json();

         //Redirect user/customer stripe checkout
         
         const result = await stripe.redirectToCheckout({
             sessionId:sessionn.data.id
         });
